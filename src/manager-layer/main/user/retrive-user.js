...
const { dbRetriveUser } = require("dbLayer");

class RetriveUserManager extends UserManager {
  ...
  async doBusiness() {
    // Call DbFunction
    // make an awaited call to the dbRetriveUser function to get the user and return the result to the controller
    const user = await dbRetriveUser(this);
...
module.exports = RetriveUserManager;
