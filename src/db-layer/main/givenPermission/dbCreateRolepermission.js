...
class DbCreateRolepermissionCommand extends DBCreateSequelizeCommand {
  constructor(input) {
    super(input);
    this.commandName = "dbCreateRolepermission";
...
const dbCreateRolepermission = async (input) => {
  const dbCreateCommand = new DbCreateRolepermissionCommand(input);
  return await dbCreateCommand.execute();
};

module.exports = dbCreateRolepermission;
