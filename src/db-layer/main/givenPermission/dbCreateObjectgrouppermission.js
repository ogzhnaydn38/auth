...
class DbCreateObjectgrouppermissionCommand extends DBCreateSequelizeCommand {
  constructor(input) {
    super(input);
    this.commandName = "dbCreateObjectgrouppermission";
...
const dbCreateObjectgrouppermission = async (input) => {
  const dbCreateCommand = new DbCreateObjectgrouppermissionCommand(input);
  return await dbCreateCommand.execute();
};

module.exports = dbCreateObjectgrouppermission;
