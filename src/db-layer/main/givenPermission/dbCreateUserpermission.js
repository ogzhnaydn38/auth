...
class DbCreateUserpermissionCommand extends DBCreateSequelizeCommand {
  constructor(input) {
    super(input);
    this.commandName = "dbCreateUserpermission";
...
const dbCreateUserpermission = async (input) => {
  const dbCreateCommand = new DbCreateUserpermissionCommand(input);
  return await dbCreateCommand.execute();
};

module.exports = dbCreateUserpermission;
