...
class DbCreateObjectgrouprolepermissionCommand extends DBCreateSequelizeCommand {
  constructor(input) {
    super(input);
    this.commandName = "dbCreateObjectgrouprolepermission";
...
const dbCreateObjectgrouprolepermission = async (input) => {
  const dbCreateCommand = new DbCreateObjectgrouprolepermissionCommand(input);
  return await dbCreateCommand.execute();
};

module.exports = dbCreateObjectgrouprolepermission;
