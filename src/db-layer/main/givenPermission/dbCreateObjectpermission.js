...
class DbCreateObjectpermissionCommand extends DBCreateSequelizeCommand {
  constructor(input) {
    super(input);
    this.commandName = "dbCreateObjectpermission";
...
const dbCreateObjectpermission = async (input) => {
  const dbCreateCommand = new DbCreateObjectpermissionCommand(input);
  return await dbCreateCommand.execute();
};

module.exports = dbCreateObjectpermission;
