...
class DbCreateGrouppermissionCommand extends DBCreateSequelizeCommand {
  constructor(input) {
    super(input);
    this.commandName = "dbCreateGrouppermission";
...
const dbCreateGrouppermission = async (input) => {
  const dbCreateCommand = new DbCreateGrouppermissionCommand(input);
  return await dbCreateCommand.execute();
};

module.exports = dbCreateGrouppermission;
