...
class DbCreateRolegrouppermissionCommand extends DBCreateSequelizeCommand {
  constructor(input) {
    super(input);
    this.commandName = "dbCreateRolegrouppermission";
...
const dbCreateRolegrouppermission = async (input) => {
  const dbCreateCommand = new DbCreateRolegrouppermissionCommand(input);
  return await dbCreateCommand.execute();
};

module.exports = dbCreateRolegrouppermission;
