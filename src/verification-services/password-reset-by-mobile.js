...
class PasswordResetByMobile extends VerificationServiceBase {
  constructor(req) {
    super(req, "byCode");
    this.startTopic = "tickatme-user-service-password-reset-by-mobile-start";
    this.completeTopic =
      "tickatme-user-service-password-reset-by-mobile-complete";
  }
  ...
  async startPasswordReset() {
    ...
    mobileReset.expireTime = Number(60);
