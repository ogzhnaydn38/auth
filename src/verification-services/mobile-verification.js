...
class MobileVerification extends VerificationServiceBase {
  constructor(req) {
    super(req, "byCode");
    this.startTopic = "tickatme-user-service-mobile-verification-start";
    this.completeTopic = "tickatme-user-service-mobile-verification-complete";
  }
  ...
  async startVerification() {
    ...
    mobileVerification.expireTime = Number(60);
