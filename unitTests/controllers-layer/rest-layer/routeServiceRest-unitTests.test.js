...
//For these tests to work we need to export RegisterUserRestController also from file register-user.js
describe("RegisterUserRestController", () => {
  ...
  describe("RegisterUserRestController class", () => {
    it("should extend RestController with correct values", () => {
      ...
      expect(controller.routeName).to.equal("register-user");
